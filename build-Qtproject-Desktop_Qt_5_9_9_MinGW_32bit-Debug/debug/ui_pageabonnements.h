...
public:
    ...
    void setupUi(QDialog *Pageabonnements)
    {
        ...
        Pageabonnements->resize(1088, 759);
        ...
        tabWidget->setGeometry(QRect(200, 10, 841, 731));
        tab = new QWidget();
        tab->setObjectName(QStringLiteral("tab"));
        Group = new QGroupBox(tab);
        Group->setObjectName(QStringLiteral("Group"));
        Group->setGeometry(QRect(0, 0, 821, 691));
...
""));
        ...
        label_7->setStyleSheet(QStringLiteral("image: url(:/img/img/img.jpg);"));

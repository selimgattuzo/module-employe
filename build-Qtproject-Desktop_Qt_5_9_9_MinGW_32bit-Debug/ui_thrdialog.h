...
""));
        ...
        label_11->setStyleSheet(QStringLiteral("border-image: url(:/img/img/health-still-life-with-copy-space.jpg);"));
        ...
        label_10->setStyleSheet(QStringLiteral("border-image: url(:/img/img/images.jfif);"));
        label_10->raise();
        logoutpb->raise();
        tabWidget->raise();
        backpb->raise();
